...
# IAPR-6- Module 6 - FoC
## 1. Implementation of the concept of pointer to function.
## 2. Implementation of programs using structure and union.
## 3. Implementation of programs for different storage classes.
# Ex.No:26
